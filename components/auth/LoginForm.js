  ...
  return (
    ...
    <section className="w-full max-w-md p-8 space-y-6 bg-card border rounded-2xl shadow-xl">
      ...
      {authError === "OAuthAccountNotLinked" && (
        <div role="alert" className="p-3 text-sm text-red-500 bg-red-500/10 rounded-md border border-red-500/20">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Link href="/forgot-password" title="Reset your PeerNotez password" className="text-xs text-primary hover:underline">Forgot password?</Link>
          </div>
          <div className="relative">
      ...
      <footer className="text-center text-sm text-muted-foreground">
        Don't have an account? <Link href="/signup" title="Create a new PeerNotez account" className="text-primary font-medium hover:underline">Sign up</Link>
      </footer>
    </section>
  );
}
...
export default function DonatePageClient() {
    ...
    const styles = {
        wrapper: { 
            paddingTop: '4rem', paddingBottom: '8rem', minHeight: '100vh',
        ...
        <article className="container mx-auto px-4" style={styles.wrapper}>
            ...
            >
                ...
                <div className="flex justify-center gap-4">
                    <Link href="/about" title="Read our story" className="inline-flex items-center px-8 py-3 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 text-white font-bold transition-all">
                        <FaRocket className="mr-2 text-cyan-400" aria-hidden="true" /> My Story
                    </Link>
                    <Link href="/supporters" title="View our wall of fame" className="inline-flex items-center px-8 py-3 rounded-full bg-pink-500/10 border border-pink-500/20 hover:bg-pink-500/20 text-pink-400 font-bold transition-all">
            ...
            <section className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto p-12 rounded-[48px] bg-gradient-to-br from-[#0a0118] to-transparent border border-white/10 relative overflow-hidden backdrop-blur-2xl" aria-label="Lead Developer message">
                 ...
                 <div className="text-center lg:text-left relative z-10">
                    ...
                    <div className="flex items-center gap-6 justify-center lg:justify-start text-white/40 text-sm mb-10">
                        ...
                        <span className="flex items-center gap-2"><FaCheckCircle className="text-green-500" aria-hidden="true" /> Student Focused</span>
                    </div>
                    <a 
                        href={bmacLink}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center px-10 py-5 rounded-full bg-yellow-400 text-black font-black text-xl hover:scale-105 active:scale-95 transition-all shadow-[0_0_30px_rgba(250,204,21,0.3)]"
                    >
                        <FaCoffee className="mr-3" aria-hidden="true" /> Buy me a coffee
                    </a>
                 </div>
                 ...
                 <div className="relative flex justify-center">
                    ...
                    <div className="relative bg-[#0a0118] p-4 rounded-[40px] border border-white/10">
                        ...
                        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 w-[80%] bg-black/60 backdrop-blur-md border border-white/10 p-4 rounded-2xl text-center">
                            <h3 className="text-white font-bold">Aditya Choudhary</h3>
                            <p className="text-yellow-400 text-[10px] font-black uppercase tracking-widest">Solo Architect</p>
                        </div>
                    </div>
                 </div>
            </section>
